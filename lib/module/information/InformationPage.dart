                            ...
                            child: Text(t.name,
                                ...
                                style: TextStyle(
                                  color: bloc.sortId == t.id
                                      ...
                                      : Color(0xFFA2A2A6),
                                  fontSize: 14,
                                  fontWeight: bloc.sortId == t.id ?  FontWeight.w600 : FontWeight.normal,
                                )),
                          ),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  padding: const EdgeInsets.only(
                                      left: 20.0, right: 20, top: 12),
                                  child: Text(
                                      bloc.parseHtmlString(bloc.words[index].body),
                                      maxLines: 3,
                                      overflow: TextOverflow.ellipsis,
                                      textAlign: TextAlign.left,
                                      style: TextStyle(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Text(DateTime.parse(bloc.words[index].updated).toString().substring(0,DateTime.parse(bloc.words[index].updated).toString().length - 5),
                                            maxLines: 1,
                                            overflow: TextOverflow.ellipsis,
                                            textAlign: TextAlign.left,
                                            style: TextStyle(
